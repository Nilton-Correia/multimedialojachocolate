...
<header class="header-area">
    ...
    <section class="owl-video-wrapper" <div class="container-fluid nopadding video_fullwidth_contenu">

    <video playsinline autoplay muted loop>
        <source src="https://diogovazchocolate.com/wp-content/uploads/2019/06/Diogo-Vaz-Chocolate-video-presentation-courte-1.mp4" type="video/mp4" />
    </video>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading wow fadeInUp">
                        <h2>Produtos</h2>
                        <h3>Queremos manter e melhorar os fundamentos essenciais para um chocolate de qualidade</h3>
                    </div>
                </div>
            </div>
