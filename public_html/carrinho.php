...
$pdoConnection = require_once "config.php";
            ...
            <table class="table table-strip">
                ...
                <?php foreach($resultsCarts as $result) : ?>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="prod[<?php echo $result['ID_Produto']?>]" value="<?php echo $result['quantity']?>" size="1" />

                        </td>
                        <td><?php echo number_format($result['preco'], 2, ',', '.')?>€</td>
                        <td><?php echo number_format($result['subtotal'], 2, ',', '.')?>€</td>
                        <td><a href="carrinho.php?acao=del&id=<?php echo $result['ID_Produto']?>" class="btn btn-danger">Remover</a></td>
